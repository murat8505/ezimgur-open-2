...
import com.ezimgur.ui.widget.ClippingRelativeLayout;
...
public abstract class ParallaxedView {
    ...
    public void setOffset(float offset) {
        ClippingRelativeLayout view = (ClippingRelativeLayout) this.view.get();
        if (view != null) {
            if (isAPI11) {
            ...
            int extra = (int) offset / 10;
            view.setClipY((int) offset - extra);
        }
    }

    @SuppressLint("NewApi")
    public void setOffsetScroll(float offset) {
