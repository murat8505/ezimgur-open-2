...
import com.ezimgur.ui.utils.ViewUtils;
...
public class ResizingImageView extends ImageView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (drawable != null) {
            ...
            int dWidth = (int) ViewUtils.dipToPixels(getContext(), drawable.getIntrinsicWidth());
            int dHeight = (int) ViewUtils.dipToPixels(getContext(), drawable.getIntrinsicHeight());
